...
public interface HunspellLibrary extends Library {
	...
	/**
	 * Free the memory used by the lists created as output from the other
	 * functions.
	 * 
	 * @param pHunspell
	 *            the Hunspell object returned by
	 *            {@link #Hunspell_create(String, String)}
	 * @param slst
	 *            the {@link PointerByReference} (<code>char***</code>) that is
	 *            used for the suggestion lists
	 * @param n
	 */
	public void Hunspell_free_list(Pointer pHunspell, PointerByReference slst,
			int n);
