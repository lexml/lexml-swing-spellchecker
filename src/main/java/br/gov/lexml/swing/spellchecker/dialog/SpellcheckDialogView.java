...
public class SpellcheckDialogView extends JDialog implements ActionListener, ListSelectionListener {
	...
	private void initialize() {
		...
		getContentPane().setLayout(
				new FormLayout(new ColumnSpec[] { FormFactory.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), FormFactory.RELATED_GAP_COLSPEC,
						...
						RowSpec.decode("bottom:default"), FormFactory.RELATED_GAP_ROWSPEC, FormFactory.DEFAULT_ROWSPEC, FormFactory.RELATED_GAP_ROWSPEC,
						FormFactory.DEFAULT_ROWSPEC, FormFactory.RELATED_GAP_ROWSPEC, RowSpec.decode("bottom:default"), FormFactory.RELATED_GAP_ROWSPEC,
						FormFactory.DEFAULT_ROWSPEC, FormFactory.RELATED_GAP_ROWSPEC, RowSpec.decode("top:50dlu"), FormFactory.RELATED_GAP_ROWSPEC,
		...
		txtNaoConsta.setEditorKit(new WrapEditorKit());
		JScrollPane jsp = new JScrollPane(txtNaoConsta);
		jsp.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);

		getContentPane().add(jsp, "2, 4, 1, 3, default, fill");
	...
	class WrapLabelView extends InlineView {
